class CreateStackJob < DockerApiJob
  ...
  private
    ...
    def create_stack(challenge)
      ...
      network['Name'] = "tf-#{challenge['problem_id']}-#{challenge['user_id']}"
      network['Labels'] = {
        "user_id" => "#{challenge['user_id']}",
        "problem_id" => "#{challenge['problem_id']}",
        "lifetime" => "#{challenge['lifespan']}",
        "trackforge" => "This network was generated by TrackForge"
      }
      ...
      services.each do |service|
        ...
        service['Labels']["trackforge"] = "This service was generated by TrackForge"
        ...
        service['Name'] = "tf-#{service_name}-#{challenge['user_id']}"
